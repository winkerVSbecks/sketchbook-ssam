...
export const sketch = async ({
  ...
  const clipRects: Point[][] = [
    getRect(gridConfig, { x: 1, y: 0, w: 2, h: 1 }),
    getRect(gridConfig, { x: 2, y: 1, w: 1, h: 1 }),
    getRect(gridConfig, { x: 2, y: 2, w: 1, h: 1 }),
    getRect(gridConfig, { x: 1, y: 3, w: 2, h: 0.5 }),
  ...
  const systemDefs = [
    ...
    {
      clipRect: clipRects[2],
      size: 12,
      colors: colorPairs[0],
      config: { padding: 0 },
    },
    {
      clipRect: clipRects[3],
      size: 12,
      colors: colorPairs[0],
      config: { padding: 0 },
    },
    {
      clipRect: clipRects[4],
      size: 24,
      colors: colorPairs[1],
      config: { padding: 0 },
    },
